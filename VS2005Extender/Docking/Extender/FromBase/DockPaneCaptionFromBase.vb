...
#End Region
        ...
        Protected Friend Sub New(ByVal pane As DockPane)
            ...
            m_buttonClose.ActiveBackColorGradientBegin = Color.FromArgb(200, 200, 200)
            m_buttonClose.ActiveBackColorGradientEnd = Color.FromArgb(90, 90, 90)
            ...
            m_buttonAutoHide.ActiveBackColorGradientBegin = Color.FromArgb(200, 200, 200)
            m_buttonAutoHide.ActiveBackColorGradientEnd = Color.FromArgb(90, 90, 90)
            ...
            m_buttonOptions.ActiveBackColorGradientBegin = Color.FromArgb(200, 200, 200)
            m_buttonOptions.ActiveBackColorGradientEnd = Color.FromArgb(90, 90, 90)
...
#End Region
        ...
        Protected Overloads Overrides Sub OnPaint(ByVal e As PaintEventArgs)
            MyBase.OnPaint(e)
            'Color.FromArgb(59, 128, 237)
            If DockPane.IsActivated Then
                Using brush As LinearGradientBrush = New LinearGradientBrush(ClientRectangle, Color.FromArgb(90, 90, 90), Color.FromArgb(200, 200, 200), LinearGradientMode.Vertical)
